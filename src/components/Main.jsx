...
const Main = () => {
  return (
    <>
      <main className=" relative max-w-full h-auto px-5 py-5 md:px-20 md:py-10">
        <div className=" absolute top-32 left-5 right-5 max-w-md h-full leading-relaxed text-white space-y-4 ">
          <p className="text-4xl md:text-5xl font-semibold leading-14">
            <span className="text-green-600">Welcome</span> To{" "}
            <span className="text-red-500 ">Red Chili</span> - Your Perfect Bite
            <span className="text-yellow-400"> Awaits</span> 🤷‍♂️
          </p>
          ...
          <form className=" leading-relaxed py-5">
            <label htmlFor="" className="text-3xl px-1 font-semibold">
              Quick Booking Here{" "}
            </label>
            <div className="flex gap-3 py-2">
              ...
              <button
                type="submit"
                class="flex items-center bg-blue-500 text-white gap-1 px-4 cursor-pointer font-semibold tracking-widest rounded-md hover:bg-blue-400 duration-300 hover:gap-2 hover:translate-x-3"
              >
                Send
                <svg
                  class="w-5 h-5 hover:animate-spin"
                  stroke="currentColor"
                  stroke-width="1.5"
                  viewBox="0 0 24 24"
                  fill="none"
          ...
          <div className=" w-full flex justify-between flex-wrap items-center py-2">
            <img
              ...
              className="hover:scale-105 hover:transition-all duration-300 ease-in-out object-cover h-auto w-40 sm:w-52"
            />
            <img
